...
namespace CRM.Migrations
{
    ...
    [Migration("20240804073001_AddedNewMig")]
    partial class AddedNewMig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CRM.Models.Domain.Client", b =>
                {
                    ...
                    b.Property<Guid?>("Client_ProjectId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CRM.Models.Domain.Project", b =>
                {
                    b.HasOne("CRM.Models.Domain.Client", null)
                        .WithMany("Projects")
                        .HasForeignKey("Client_ProjectId");
